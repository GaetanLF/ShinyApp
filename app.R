...
tabsetPanel(
  ...
  tabPanel("Exercice 2",
           ...
           h2("Partie I : l'analyse en composantes principales"),
           wellPanel(
           ...
           wellPanel(sliderInput(inputId="NClust",
             label="Choisissez le nombre de classes à prendre en compte dans l'algorithme des k-means : ",
             min=2,
             max=6,
             value=2
           ),
           checkboxGroupInput(inputId="VarCube",label="Pour le graphique 3D, veuillez choisir les variables que vous souhaitez
                              représenter : ")),

           mainPanel(align="right",fluidRow(
             column(6,plotOutput(outputId="HCPlot"),),
             column(6,tableOutput(outputId = "KTab"))
           )),
  ...
  tabPanel("Exercice 3",
            ...
            tableOutput(outputId = "cos21"), # Shows cos2 from the 2D factorial plan
            tableOutput(outputId = "cos22"),
            h3("Question 1"),
            p("Ici, le plan factoriel explique 86.23% de l'inertie. Ainsi, les deux dimensions du plan contiennent la grande majorité
              de l'information."),
            h3("Question 2"),
